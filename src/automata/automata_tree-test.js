...
describe('automata_tree', function () {
	...
	it('#actual automata', function (done) {
		...
		tree[0x43][0x4f][0x4e][0x45][0x43][0x54].should.be.instanceof(Array);
		tree[0x43][0x4f][0x4e][0x45][0x43][0x54].length.should.not.equal(0);
		tree[0x4d][0x41][0x53][0x54][0x45][0x52].should.be.instanceof(Array);
		tree[0x4d][0x41][0x53][0x54][0x45][0x52].length.should.not.equal(0);
